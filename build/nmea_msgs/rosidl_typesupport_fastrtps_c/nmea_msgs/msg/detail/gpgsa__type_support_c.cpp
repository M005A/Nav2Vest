...
bool cdr_serialize_nmea_msgs__msg__Gpgsa(
  const nmea_msgs__msg__Gpgsa * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
bool cdr_deserialize_nmea_msgs__msg__Gpgsa(
  eprosima::fastcdr::Cdr & cdr,
  nmea_msgs__msg__Gpgsa * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
bool cdr_serialize_key_nmea_msgs__msg__Gpgsa(
  const nmea_msgs__msg__Gpgsa * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
size_t get_serialized_size_key_nmea_msgs__msg__Gpgsa(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gpgsa__ros_msg_type * ros_message = static_cast<const _Gpgsa__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
size_t max_serialized_size_key_nmea_msgs__msg__Gpgsa(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nmea_msgs__msg__Gpgsa * ros_message = static_cast<const nmea_msgs__msg__Gpgsa *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nmea_msgs__msg__Gpgsa(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nmea_msgs__msg__Gpgsa * ros_message = static_cast<nmea_msgs__msg__Gpgsa *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nmea_msgs__msg__Gpgsa(cdr, ros_message);
}
