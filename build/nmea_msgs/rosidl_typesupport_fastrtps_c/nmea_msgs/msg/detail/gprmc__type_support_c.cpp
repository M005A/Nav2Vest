...
bool cdr_serialize_nmea_msgs__msg__Gprmc(
  const nmea_msgs__msg__Gprmc * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
bool cdr_deserialize_nmea_msgs__msg__Gprmc(
  eprosima::fastcdr::Cdr & cdr,
  nmea_msgs__msg__Gprmc * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
bool cdr_serialize_key_nmea_msgs__msg__Gprmc(
  const nmea_msgs__msg__Gprmc * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
size_t get_serialized_size_key_nmea_msgs__msg__Gprmc(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gprmc__ros_msg_type * ros_message = static_cast<const _Gprmc__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
size_t max_serialized_size_key_nmea_msgs__msg__Gprmc(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nmea_msgs__msg__Gprmc * ros_message = static_cast<const nmea_msgs__msg__Gprmc *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nmea_msgs__msg__Gprmc(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nmea_msgs__msg__Gprmc * ros_message = static_cast<nmea_msgs__msg__Gprmc *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nmea_msgs__msg__Gprmc(cdr, ros_message);
}
