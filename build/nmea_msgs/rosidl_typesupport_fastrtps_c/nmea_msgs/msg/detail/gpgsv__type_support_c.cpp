...
bool cdr_serialize_nmea_msgs__msg__Gpgsv(
  const nmea_msgs__msg__Gpgsv * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: satellites
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_nmea_msgs__msg__GpgsvSatellite(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
bool cdr_deserialize_nmea_msgs__msg__Gpgsv(
  eprosima::fastcdr::Cdr & cdr,
  nmea_msgs__msg__Gpgsv * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: satellites
  {
    ...
    auto array_ptr = ros_message->satellites.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_nmea_msgs__msg__GpgsvSatellite(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
bool cdr_serialize_key_nmea_msgs__msg__Gpgsv(
  const nmea_msgs__msg__Gpgsv * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: satellites
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_nmea_msgs__msg__GpgsvSatellite(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
size_t get_serialized_size_key_nmea_msgs__msg__Gpgsv(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gpgsv__ros_msg_type * ros_message = static_cast<const _Gpgsv__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: satellites
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_nmea_msgs__msg__GpgsvSatellite(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nmea_msgs
size_t max_serialized_size_key_nmea_msgs__msg__Gpgsv(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: satellites
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_nmea_msgs__msg__GpgsvSatellite(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nmea_msgs__msg__Gpgsv * ros_message = static_cast<const nmea_msgs__msg__Gpgsv *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nmea_msgs__msg__Gpgsv(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nmea_msgs__msg__Gpgsv * ros_message = static_cast<nmea_msgs__msg__Gpgsv *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nmea_msgs__msg__Gpgsv(cdr, ros_message);
}
