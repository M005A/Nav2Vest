...
bool cdr_serialize_geographic_msgs__msg__GeoPoseWithCovariance(
  const geographic_msgs__msg__GeoPoseWithCovariance * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_geographic_msgs__msg__GeoPoseWithCovariance(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs__msg__GeoPoseWithCovariance * ros_message);
...
bool cdr_serialize_key_geographic_msgs__msg__GeoPoseWithCovariance(
  const geographic_msgs__msg__GeoPoseWithCovariance * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_geographic_msgs__msg__GeoPoseWithCovariance(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_geographic_msgs__msg__GeoPoseWithCovariance(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_geographic_msgs__msg__GeoPoseWithCovarianceStamped(
  const geographic_msgs__msg__GeoPoseWithCovarianceStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: pose
  {
    cdr_serialize_geographic_msgs__msg__GeoPoseWithCovariance(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_deserialize_geographic_msgs__msg__GeoPoseWithCovarianceStamped(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs__msg__GeoPoseWithCovarianceStamped * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: pose
  {
    cdr_deserialize_geographic_msgs__msg__GeoPoseWithCovariance(cdr, &ros_message->pose);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_serialize_key_geographic_msgs__msg__GeoPoseWithCovarianceStamped(
  const geographic_msgs__msg__GeoPoseWithCovarianceStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: pose
  {
    cdr_serialize_key_geographic_msgs__msg__GeoPoseWithCovariance(
      &ros_message->pose, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t get_serialized_size_key_geographic_msgs__msg__GeoPoseWithCovarianceStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GeoPoseWithCovarianceStamped__ros_msg_type * ros_message = static_cast<const _GeoPoseWithCovarianceStamped__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: pose
  current_alignment += get_serialized_size_key_geographic_msgs__msg__GeoPoseWithCovariance(
    &(ros_message->pose), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t max_serialized_size_key_geographic_msgs__msg__GeoPoseWithCovarianceStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_geographic_msgs__msg__GeoPoseWithCovariance(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geographic_msgs__msg__GeoPoseWithCovarianceStamped * ros_message = static_cast<const geographic_msgs__msg__GeoPoseWithCovarianceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geographic_msgs__msg__GeoPoseWithCovarianceStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geographic_msgs__msg__GeoPoseWithCovarianceStamped * ros_message = static_cast<geographic_msgs__msg__GeoPoseWithCovarianceStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geographic_msgs__msg__GeoPoseWithCovarianceStamped(cdr, ros_message);
}
