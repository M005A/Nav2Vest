...
bool
geographic_msgs__msg__KeyValue__are_equal(const geographic_msgs__msg__KeyValue * lhs, const geographic_msgs__msg__KeyValue * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
geographic_msgs__msg__KeyValue__copy(
  const geographic_msgs__msg__KeyValue * input,
  geographic_msgs__msg__KeyValue * output)
{
  if (!input || !output) {
    return false;
  }
...
geographic_msgs__msg__KeyValue__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  geographic_msgs__msg__KeyValue * msg = (geographic_msgs__msg__KeyValue *)allocator.allocate(sizeof(geographic_msgs__msg__KeyValue), allocator.state);
  if (!msg) {
    return NULL;
  }
...
geographic_msgs__msg__KeyValue__Sequence__init(geographic_msgs__msg__KeyValue__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geographic_msgs__msg__KeyValue *)allocator.zero_allocate(size, sizeof(geographic_msgs__msg__KeyValue), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  geographic_msgs__msg__KeyValue__Sequence * array = (geographic_msgs__msg__KeyValue__Sequence *)allocator.allocate(sizeof(geographic_msgs__msg__KeyValue__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
geographic_msgs__msg__KeyValue__Sequence__are_equal(const geographic_msgs__msg__KeyValue__Sequence * lhs, const geographic_msgs__msg__KeyValue__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!geographic_msgs__msg__KeyValue__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
geographic_msgs__msg__KeyValue__Sequence__copy(
  const geographic_msgs__msg__KeyValue__Sequence * input,
  geographic_msgs__msg__KeyValue__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(geographic_msgs__msg__KeyValue);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    geographic_msgs__msg__KeyValue * data =
      (geographic_msgs__msg__KeyValue *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!geographic_msgs__msg__KeyValue__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          geographic_msgs__msg__KeyValue__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!geographic_msgs__msg__KeyValue__copy(
