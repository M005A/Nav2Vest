...
inline std::string to_yaml(const GetRoutePlan_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use geographic_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const geographic_msgs::srv::GetRoutePlan_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  geographic_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use geographic_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const geographic_msgs::srv::GetRoutePlan_Event & msg)
{
  return geographic_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<geographic_msgs::srv::GetRoutePlan_Event>()
{
  return "geographic_msgs::srv::GetRoutePlan_Event";
}

template<>
inline const char * name<geographic_msgs::srv::GetRoutePlan_Event>()
{
  return "geographic_msgs/srv/GetRoutePlan_Event";
}

template<>
struct has_fixed_size<geographic_msgs::srv::GetRoutePlan_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<geographic_msgs::srv::GetRoutePlan_Event>
  : std::integral_constant<bool, has_bounded_size<geographic_msgs::srv::GetRoutePlan_Request>::value && has_bounded_size<geographic_msgs::srv::GetRoutePlan_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<geographic_msgs::srv::GetRoutePlan_Event>
  : std::true_type {};
