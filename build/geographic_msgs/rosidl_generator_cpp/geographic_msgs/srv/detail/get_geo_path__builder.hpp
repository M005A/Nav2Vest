...
class Init_GetGeoPath_Event_response
{
public:
  explicit Init_GetGeoPath_Event_response(::geographic_msgs::srv::GetGeoPath_Event & msg)
  : msg_(msg)
  {}
  ::geographic_msgs::srv::GetGeoPath_Event response(::geographic_msgs::srv::GetGeoPath_Event::_response_type arg)
  {
...
private:
  ::geographic_msgs::srv::GetGeoPath_Event msg_;
};

class Init_GetGeoPath_Event_request
{
public:
  explicit Init_GetGeoPath_Event_request(::geographic_msgs::srv::GetGeoPath_Event & msg)
  : msg_(msg)
  {}
  Init_GetGeoPath_Event_response request(::geographic_msgs::srv::GetGeoPath_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetGeoPath_Event_response(msg_);
  }
...
class Init_GetGeoPath_Event_info
{
public:
  Init_GetGeoPath_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetGeoPath_Event_request info(::geographic_msgs::srv::GetGeoPath_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetGeoPath_Event_request(msg_);
  }
...
template<>
inline
auto build<::geographic_msgs::srv::GetGeoPath_Event>()
{
  return geographic_msgs::srv::builder::Init_GetGeoPath_Event_info();
}
