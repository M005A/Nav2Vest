...
// IWYU pragma: private, include "geographic_msgs/msg/geo_path.hpp"
...
struct GeoPath_
{
  ...
  _header_type header;
  using _poses_type =
    std::vector<geographic_msgs::msg::GeoPoseStamped_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::GeoPoseStamped_<ContainerAllocator>>>;
  _poses_type poses;
  ...
  Type & set__poses(
    const std::vector<geographic_msgs::msg::GeoPoseStamped_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::GeoPoseStamped_<ContainerAllocator>>> & _arg)
  {
    this->poses = _arg;
    return *this;
  }
