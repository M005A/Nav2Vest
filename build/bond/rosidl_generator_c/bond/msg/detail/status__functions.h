...
// IWYU pragma: private, include "bond/msg/status.h"


#ifndef BOND__MSG__DETAIL__STATUS__FUNCTIONS_H_
#define BOND__MSG__DETAIL__STATUS__FUNCTIONS_H_
 ...
 * calls
 * bond__msg__Status__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bond
bond__msg__Status *
bond__msg__Status__create(void);

/// Destroy msg/Status message.
/**
 * It calls
 * bond__msg__Status__fini()
...
bond__msg__Status__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * bond__msg__Status__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * bond__msg__Status__Sequence__fini()
 * on the array,
...
#endif  // BOND__MSG__DETAIL__STATUS__FUNCTIONS_H_
