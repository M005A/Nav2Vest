...
bond__msg__Constants__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bond__msg__Constants * msg = (bond__msg__Constants *)allocator.allocate(sizeof(bond__msg__Constants), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bond__msg__Constants));
  bool success = bond__msg__Constants__init(msg);
  if (!success) {
...
bond__msg__Constants__destroy(bond__msg__Constants * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    bond__msg__Constants__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bond__msg__Constants__Sequence__init(bond__msg__Constants__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bond__msg__Constants * data = NULL;

  if (size) {
    data = (bond__msg__Constants *)allocator.zero_allocate(size, sizeof(bond__msg__Constants), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bond__msg__Constants__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bond__msg__Constants__fini(&data[i - 1]);
      }
...
bond__msg__Constants__Sequence__fini(bond__msg__Constants__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bond__msg__Constants__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bond__msg__Constants__Sequence * array = (bond__msg__Constants__Sequence *)allocator.allocate(sizeof(bond__msg__Constants__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bond__msg__Constants__Sequence__init(array, size);
  if (!success) {
...
bond__msg__Constants__Sequence__destroy(bond__msg__Constants__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bond__msg__Constants__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bond__msg__Constants__Sequence__are_equal(const bond__msg__Constants__Sequence * lhs, const bond__msg__Constants__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bond__msg__Constants__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bond__msg__Constants__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bond__msg__Constants);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bond__msg__Constants * data =
      (bond__msg__Constants *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bond__msg__Constants__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bond__msg__Constants__fini(&output->data[i]);
        }
        return false;
      }
    }
