    ...
    return [
        ...
        Node(
            ...
            parameters=[{
                ...
                'clear_width_m': 0.26,
                'obstacle_hold_frames': 0,
                'display_obstacle_hold_frames': 0,
                'planning_obstacle_hold_frames': 0,
                'free_space_hold_frames': 0,
                ...
                'enable_rolling_grid_memory': False,
